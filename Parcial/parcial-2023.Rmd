...
estimador_p_estr <- function(sample_elect, total_elect, next_strata ){
  ...
  p_si_estr = nom_p_si/den_p
  p_no_estr = nom_p_no/den_p
  p_nu_estr = nom_p_nu/den_p
  results_p_estr <- tibble(p_si_estr, p_no_estr, p_nu_estr, check = p_si_estr+p_no_estr+p_nu_estr)
...
next_strata = muestra_tidy$ESTRATO[1]
